...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     ...
     <div style="background-image:url('../Image/bg4.png'); width:100%; height:720px; background-repeat: no-repeat; background-size:cover; background-attachment:fixed;">
        <div class="container p-md-4 p-sm-4">
            ...
            <div class="row mb-3 mr-lg-5 mb-lg-5 mt-md-5">
                <div class="col-md-6"> 
            ...
            <div class="row mb-3 mr-lg-5 mb-lg-5">
             ...
             <div class="row mb-3 mr-lg-5 mb-lg-5 mt-md-5">
                <div class="col-md-6">
                    <asp:GridView ID="GridView1" runat="server" CssClass="table table-hover table-bordered" DataKeyNames="ClassId" AutoGenerateColumns="False" 
                        ...
                        OnRowUpdating="GridView1_RowUpdating" OnRowEditing="GridView1_RowEditing" AllowPaging="true" PageSize="4" >
                        <Columns>
